...
const deriveInvestorPdaAta = async (
...
const executeCategoryClaimTx = async (): Promise<string> => {
  ...
  const sig = await program.methods
    ...
    .accountsStrict({
      ...
      preSeedCat: (await deriveInvestorPdaAta("preseed", mint))[0],
      preSeedAta: (await deriveInvestorPdaAta("preseed", mint))[1],
      seedCat: (await deriveInvestorPdaAta("seed", mint))[0],
      seedAta: (await deriveInvestorPdaAta("seed", mint))[1],
      institutionalCat: (await deriveInvestorPdaAta("institutional", mint))[0],
      institutionalAta: (await deriveInvestorPdaAta("institutional", mint))[1],
      vgpCat: (await deriveInvestorPdaAta("vgp", mint))[0],
      vgpAta: (await deriveInvestorPdaAta("vgp", mint))[1],
      foundersCat: (await deriveInvestorPdaAta("founders", mint))[0],
      foundersAta: (await deriveInvestorPdaAta("founders", mint))[1],
      marketingCat: (await deriveInvestorPdaAta("marketing", mint))[0],
      marketingAta: await deriveAta(MARKETING_AUTHORITY, mint),
      reserveCat: (await deriveInvestorPdaAta("reserve", mint))[0],
      reserveAta: await deriveAta(RESERVE_AUTHORITY, mint),
      liquidityCat: (await deriveInvestorPdaAta("liquidity", mint))[0],
